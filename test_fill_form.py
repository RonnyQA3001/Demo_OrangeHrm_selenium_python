...
from utils.data_handler import get_nationality
...
class OrangeHRMTestCases:
    ...
    def edit_personal_details(self, name):
        f = Global_functions(self.driver)
        random_number = utils.data_handler.read_js("scripts/random_number.js",self.driver)
        ...
        try:
            ...
            f.click_xpath_no_scroll("//div/div[@class='oxd-table-cell oxd-padding-cell']/div/button[@class='oxd-icon-button oxd-table-cell-action-space']/i[@class='oxd-icon bi-pencil-fill']",3)
            f.mixed_text("xpath","//body/div[@id='app']/div[@class='oxd-layout orangehrm-upgrade-layout']/div[@class='oxd-layout-container']/div[@class='oxd-layout-context']/div[@class='orangehrm-background-container']/div[@class='orangehrm-card-container']/div[@class='orangehrm-edit-employee']/div[@class='orangehrm-edit-employee-content']/div[@class='orangehrm-horizontal-padding orangehrm-vertical-padding']/form[@class='oxd-form']/div[@class='oxd-form-row']/div[@class='oxd-grid-3 orangehrm-full-width-grid']/div[2]/div[1]/div[2]/input[1]",random_number,3)
